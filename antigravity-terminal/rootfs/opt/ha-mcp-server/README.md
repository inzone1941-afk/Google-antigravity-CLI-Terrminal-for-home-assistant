...
A comprehensive Model Context Protocol (MCP) server implementing the latest MCP specification (2025-06-18) for deep integration between Antigravity Terminal and Home Assistant.
...
Add to your Antigravity config (`~/.gemini/antigravity-cli/mcp_config.json`):
