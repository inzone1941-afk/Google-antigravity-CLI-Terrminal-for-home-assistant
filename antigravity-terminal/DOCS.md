...
1. Add this repository to your Home Assistant add-on store: `https://github.com/inzone1941-afk/Google-antigravity-CLI-Terrminal-for-home-assistant`
2. Install the **Antigravity CLI Terminal** add-on.
3. Start the add-on.
4. Click **"OPEN WEB UI"** to access the terminal.
5. On first use, follow the authentication prompts (or enter an `antigravity_api_key` in the configuration for headless login).
...
- **Smart Context**: Automatically generates an `ANTIGRAVITY.md` context file for system and entity awareness.
